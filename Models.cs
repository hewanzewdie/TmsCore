...
public class Course
{
    ...
    public int Capacity
    {
        ...
        set=>field = value>0
        ?value
        : throw new ArgumentOutOfRangeException(nameof(value), "System constraing: Capacity must be greater than zero");
    }
...
public class Student
{
    ...
    public int Age
    {
        ...
        ?value:throw new ArgumentOutOfRangeException(nameof(value), "Age must be between 16 and 100");
    }
    public decimal GPA
    {
        get;
